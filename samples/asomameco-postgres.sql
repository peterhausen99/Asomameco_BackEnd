-- Create ENUM type for Assistance.State
CREATE TYPE state_enum AS ENUM ('P', 'C', 'R');

-- Create trigger function for updating ModifiedDate
...
-- Create trigger to update ModifiedDate on row update
CREATE TRIGGER update_asociated_modified_date
BEFORE UPDATE ON Asociated
FOR EACH ROW
EXECUTE FUNCTION update_modified_date();

-- Create Events table
CREATE TABLE IF NOT EXISTS Events (
    EventID         INT            NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS Assistance (
    AssistanceId        INT             NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    UserIdentity        VARCHAR(9)      NOT NULL,
    EventID             INT             NOT NULL,
    State               state_enum      NOT NULL DEFAULT 'P',
    ...
    CONSTRAINT Assistance_UK           UNIQUE (UserIdentity, EventID)
);
...
VALUES
('Conferencia: El Arte de Ser Mangoneado', '2025-04-15 10:00:00', 'Un espacio para compartir experiencias sobre cómo manejar las dinámicas del hogar bajo la guía experta de un mangoneador.', 'Centro de Convenciones Mangoneados', 100, TRUE),
('Taller: Cómo Decir "Sí Querida"', '2025-04-20 14:00:00', 'Un taller intensivo para aprender a ser un excelente seguidor de las órdenes de la jefa del hogar.', 'Auditorio Asociación Hombre Mangoneados', 50, TRUE),
('Feria: Tecnología y Mangoneo', '2025-05-05 09:00:00', 'Explora las herramientas tecnológicas que ayudan a los mangoneados a cumplir tareas con eficiencia.', 'Plaza Central de Mangoneados', 150, TRUE),
('Competencia: El Mangoneado del Año', '2025-06-10 17:00:00', 'Evento de premiación para el hombre que mejor cumple su papel en casa.', 'Estadio Mangoneado 2025', 300, TRUE),
('Charla: Cómo Sobrevivir al Mandato', '2025-06-25 15:00:00', 'Un orador experto compartirá técnicas avanzadas de adaptación y supervivencia bajo el mandato.', 'Centro Cultural Mangoneado', 200, TRUE),
('Encuentro: Hermanos Mangoneados Unidos', '2025-07-10 10:00:00', 'Reunión de hombres que buscan apoyo mutuo y comparten sus historias de éxito en la mangoneada.', 'Salón Mangoneados Unidos', 80, TRUE),
('Taller Avanzado: Cómo Ser el Mejor Mangoneado', '2025-08-01 09:00:00', 'Un curso avanzado para perfeccionar tus habilidades y ser el orgullo del hogar.', 'Centro de Innovación Mangoneados', 60, TRUE);
